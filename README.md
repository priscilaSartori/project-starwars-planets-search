...
<details>
  ...
  1. Clone o repositório: `git clone git@github.com:priscilaSartori/project-starwars-planets-search.git`
...
* <details><summary><b> Execução de testes de requisito</b></summary>
  ...
  Os testes deste projeto foram feitos utilizando o [Cypress](https://www.cypress.io/how-it-works/). 
